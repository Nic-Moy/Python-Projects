...
while recalculate == 'y':
    ...
    customer_code = str.lower(customer_code)
    while customer_code != 'i' and customer_code != 'c' and customer_code != 'r':
        print('Invalid Entry, try again')
        customer_code = str.lower(input('Enter the customer\'s code: '))
    
    beginning_meter = int(input('Enter the customer\'s beginning meter reading: '))
    while beginning_meter < meter_min or beginning_meter > meter_max:
        print('Invalid entry')
        beginning_meter = int(input('Enter the customer\'s beginning meter reading: '))
        
    end_meter = int(input('Enter the customer\'s end meter reading: '))
    while end_meter > meter_max or end_meter < meter_min:
        print('Invalid entry')
        end_meter = int(input('Enter the customer\'s end meter reading: '))
    ...
    recalculate = input('Do you want to run again? y for yes and n for no ')
    if recalculate == 'n':
        print('Goodbye')
